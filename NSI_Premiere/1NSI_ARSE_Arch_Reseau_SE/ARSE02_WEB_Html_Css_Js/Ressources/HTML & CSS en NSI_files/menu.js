...
$(function() {
		...
		******************************************************** */
		...
		var liste_onglets =	[	[['Index Général', '../../index_general.html'],
								 ['HTML & CSS en NSI', '../accueil_cours_html_css_nsi.html']],
								
								/* HTML */
								[['Principes', '../exo_html_nsi/html_accueil.html'],
								 ['Premières Balises', '../exo_html_nsi/html_balises.html'],
								 ['Les titres', '../exo_html_nsi/html_titres.html'],
								 ['Les listes', '../exo_html_nsi/html_listes.html'],
								 ['Structurer une page HTML', '../exo_html_nsi/html_structure.html'],
								 ['Balises Génériques', '../exo_html_nsi/html_generique.html'],
								/* ['Mini-projet en HTML', '../exo_html_nsi/html_mini_projet.html'] */
								],
								 
								
								/* Arborescence */
								[['Principes', '../exo_liens_nsi/liens_accueil.html'],
								 ['Liens absolus', '../exo_liens_nsi/liens_externes.html'],
								 ['Liens relatifs', '../exo_liens_nsi/liens_internes.html'],
								 ['Liens intra-page', '../exo_liens_nsi/liens_intra_page.html'],
								 /*['Mini-projet sur les liens', '../exo_liens_nsi/liens_mini_projet.html']*/
								],
								
								
								/* CSS */
								[['Principes', '../exo_css_nsi/css_accueil.html'],
								 ['Couleurs', '../exo_css_nsi/css_couleurs.html'],
								 ['Bordures', '../exo_css_nsi/css_bordures.html'],
								 ['Dimensions', '../exo_css_nsi/css_dimensions.html'],
								 ['Sélecteurs', '../exo_css_nsi/css_selecteurs.html'],
								 ['Textes', '../exo_css_nsi/css_font.html'],
								 ['Afficher', '../exo_css_nsi/css_display.html'],
								 ['Afficher avec grid', '../exo_css_nsi/css_display_grid.html'],
								 ['Centrer', '../exo_css_nsi/css_centrer.html'],
								 ['Survol souris', '../exo_css_nsi/css_survol.html'],
								/* ['Mini-projet en CSS', '../exo_css_nsi/css_mini_projet.html'] */
								],
								 
								
								/* Aller plus loin */
								[['[HTML] Tableaux', '../exo_sup_nsi/html_tableaux.html'],
								 ['[CSS] Avant/Après', '../exo_sup_nsi/css_avantapres.html'],
								 ['[CSS] Positionnement', '../exo_sup_nsi/css_positions.html']] ];
		...
		******************************************************** */
		...
		for(i=0; i < 2; i++) {
			...
			ariane_liens[i].href = liste_onglets[0][i][1];
			ariane.appendChild(ariane_li[i]);
			ariane_li[i].appendChild(ariane_liens[i]);
			ariane_liens[i].appendChild(document.createTextNode(liste_onglets[0][i][0]));
			};
		
		// Dossier et page correspondante
		if (x>0) {
			ariane_li[2] = document.createElement('li');
			ariane_li[2].innerHTML = noms_menu[x];
			ariane.appendChild(ariane_li[2]);
			
			ariane_li[3] = document.createElement('li');
			ariane_liens[3] = document.createElement('a');
			ariane_liens[3].href = liste_onglets[x][y][1];
			ariane.appendChild(ariane_li[3]);
			ariane_li[3].appendChild(ariane_liens[3]);
			ariane_liens[3].appendChild(document.createTextNode(liste_onglets[x][y][0]));
			};
