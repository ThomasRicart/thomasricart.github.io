...
\begin{propriete}[Codage UTF-8]{}
	...
	\begin{minipage}{0.49\linewidth}
		\begin{center}
			\includegraphics[width = 0.8\linewidth]{04.jpg}
			\end{center}	
	\end{minipage}
...
\begin{exercice_cours}[Créer un programme \texttt{cesar(mot:str, decalage:int, codage:bool)} qui: ]{}

	

	\begin{itemize}
		\item prend un mot au format str
		\item prend un décalage au format int
		\item code suivant le coage cesar si \verb|codage| vaut \verb|True| et décode sinon.
	\end{itemize}
\end{exercice_cours}

\begin{exercice_cours}[Faire le meme exercice avec le chiffrement de Vigenere]{}
