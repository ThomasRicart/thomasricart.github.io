...
\def\docname{AP07}        % Identifiant à gauche
...
mon_dictionnaire = {'a': 1, 'b': 2, 'c': 3}
	...
	Dans cet exemple:
	\begin{itemize}
		\item les \textbf{clés} sont \verb|'a'|, \verb|'b'| et \verb|'c'|;
		\item les \textbf{valeurs} sont 1, 2 et 3;
		\item la \textbf{clé} \verb|'a'| est associée à la \textbf{valeur} 1;
		\item le couple \textbf{clé-valeur} \verb|'b': 2| \, signifie que la \textbf{clé} \verb|'b'| est associée à la \textbf{valeur} 2;
	\end{itemize}
...
\begin{minipage}{0.31\linewidth}
	\begin{easybox}{Itérer sur les clés}{}
		\begin{CodePythontexAlt}[TaillePolice=\small, Largeur=1\linewidth,Centre,Lignes=false,PremLigne=1]{}
...
\begin{exercice_cours}{\quad}{}
			...
			\begin{enumerate}
				...
				\begin{CodePythontexAlt}[TaillePolice=\normalsize, Largeur=1\linewidth,Centre,Lignes=false,PremLigne=1]{}
					...
					assert plus_frequent([4, 2, 3, 4, 1, 4, 3, 4]) == 4
					assert plus_frequent("abracadrabra") == 'a'
				\end{CodePythontexAlt}
