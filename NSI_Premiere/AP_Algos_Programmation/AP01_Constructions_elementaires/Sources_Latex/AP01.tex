...
\def\docname{AP01}        % Identifiant à gauche
...
\begin{exemple}[Noms de variables valides et invalides]{}
    ...
    A éviter    & \verb+Variable non explicites+ (\verb|a|, \verb|x|, \verb|u| etc)\\ \hline
    \end{tabular}
\end{exemple}
...
\begin{easybox}{Les types de variables en Python}
	\begin{itemize}
		...
		\item \textbf{float}: pour les nombres à virgule flottante (ex: $3.14$, $-0.01$). La virgule est représentée par un point.
		\item \textbf{str}: pour les chaînes de caractères (ex: \verb|"Bonjour"|, \verb|'Python'|)
		\item \textbf{bool}: pour les valeurs booléennes (ex: \verb|True|, \verb|False|)
	\end{itemize}
\end{easybox}
...
\begin{easybox}{indexation des chaines de caractères}{}
 ...
 Les chaines de caractères peuvent être vues comme un ensemble de caractères \og{}collés\fg{} les uns aux autres
...
\bigskip
    ...
    \begin{tabular}{p{2cm}|p{13cm}}
        ...
        \texttt{[a:]} & conserve les caractères d'indice \texttt{[a:fin]}:  \verb~'Bonjour'[3:]~ donne \verb~'jour'~ \\
        \texttt{[:b]} & conserve les caractères d'indice \texttt{[debut:b[}:  \verb~'Bonjour'[:3]~ donne \verb~'Bon'~ \\
