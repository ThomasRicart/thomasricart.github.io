...
\begin{enumerate}
	\item Résoure l'équation homogène (E$_0$) : $y'-y=0$\sautp

	\Lignes{2}
	\item A l’aide du logiciel Géogébra, déterminer les nombres réels $a$ et $b$ pour que la fonction $p$ définie sur $\R$ par : $p(x) = ax~e^{x}$ soit une solution particulière de l'équation différentielle (E), et donner l’expression de $p$. \sautm
	
	On trouve : $a=$\makebox[0.1\linewidth]{\dotfill} \hfill $p(x)=$\makebox[0.3\linewidth]{\dotfill}\sauts
