...
\begin{enumerate}
    \item Quels sont les paramètres de la fonction \verb|ma_fonction|? \dotfill
    \item Si je veux appliquer ma fonction aux valeurs 5 et 4. que dois-je taper dans la console Python? \dotfill
    \item Comment se nomme la partie comprise entre les \verb|'''|? \dotfill
