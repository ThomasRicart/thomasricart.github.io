...
\def\docname{AP03}        % Identifiant à gauche
...
{\blocklook{mettre \ovalvariable{sortie} à {\ovalvariable{x ** 2} }}}
{\blocklook{mettre \ovalvariable{sortie} à {\ovalvariable{x ** 3} }}}
\end{scratch}	
			\end{minipage}\hfill
			\begin{minipage}{0.48\linewidth}
	\begin{lstlisting}[numbers=none]
...
assert plus_grand2(3, 5) == 5
assert plus_grand2(3, -5) == 3
	\end{CodePythontexAlt}
        \end{minipage}\hfill{}
        \begin{minipage}{0.48\linewidth}
            \begin{CodePythontexAlt}[TaillePolice=\normalsize, Largeur=1\linewidth,Centre,PremLigne=1, Lignes=true,]{}
...
assert plus_grand3(3, 5, 2) == 5
assert plus_grand3(3, -5, 2) == 3
		\end{CodePythontexAlt}
        \end{minipage}
