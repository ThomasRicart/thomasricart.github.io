...
# print(calcul_recette)
# L'exécution de cette fonction donne 4634999.999986519, et non pas 4635000.
# Le problème est dû à la représentation des flottants.
#############################################################################
...
def convertir_BCD_vers_decimal(liste_quartets):
    ...
    for i in range(n):
        chiffre = str(int(liste_quartets[n-i-1], 2))
...
# Rajout de ligne pour corriger les dépassements éventuels
...
# Test question 3:
assert additionner_nombres_format_BCD('27', '35') == convertir_dec_vers_BCD('62')

# Test question 4:
# Pb lorsque l'addition se fait sur deux nombres qui n'ont pas le meme nombre de quartets
