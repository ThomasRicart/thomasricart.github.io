...
\begin{blocvisible}[height=3]
        Le résultat renvoyé par la requête SQL serait une liste des \texttt{id\_vol} des vols dont l'aéroport d'arrivée est \verb|'CDG'|. En se basant sur la table \texttt{vol}, les vols correspondants seraient AI0015, AI01258, AI0292.
\end{blocvisible}
