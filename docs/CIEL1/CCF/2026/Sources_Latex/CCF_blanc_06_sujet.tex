...
\begin{enumerate}[resume=monDS]
    ...
    {
    \faSquare[regular] \, $\dfrac{1}{5}\big(F(0) - F(5)\big)$ \hfill \faSquare[regular] \, $\dfrac{1}{5}\big(F(5) - F(0)\big)$ \hfill \faSquare[regular] \, $\dfrac{1}{5}\big(f(5)-f(0)\big)$ \hfill \faSquare[regular] \, $\dfrac{1}{5}\big(f(0)-f(5)\big)$ \hspace{1cm} 
 }         
...
{\quad}
On trouve $n=11$ donc après 11 minutes, l'énergie sera inférieure à 100 Wh.
\end{blocvisiblex}
