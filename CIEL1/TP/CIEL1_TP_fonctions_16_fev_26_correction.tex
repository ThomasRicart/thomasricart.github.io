...
\def\date{Lundi 16 Février 2026}
...
\begin{enumerate}
    ...
    \begin{answer}{1}{1}  $a= 2$ \qquad $b= 8$  \qquad $f(x)=(2x+8)\e^{-0.5x}$  \end{answer}
    \item Montrer que la fonction dérivée de $f$ peut s'écrire sous la forme $f'(x)=-(x+2)\e^{-0.5x}$
    \begin{answer}{1}{4}  
    $f'(x)= (2x+8)\times(-0.5)\e^{-0.5x} + 2\e^{-0.5x} = -x\e^{-0.5x} - 4\e^{-0.5x} + 2\e^{-0.5x} = -(x+2)\e^{-0.5x}$
    \end{answer}
    ...
    \begin{minipage}{0.48\linewidth}
        ...
        Le signe de $f'(x)$ est donc le signe de $-(x+2)$ puisque $\e^{-0.5x}$ est toujours strictement positif. Ainsi, $f'(x)$ est positif sur $]-\infty; -2[$, nul en $-2$ et négatif sur $]-2; +\infty[$.
    
    Puisque la fonction $f$ est définie sur $[0; +\infty[$, on en déduit que $f$ est strictement décroissante sur $[0; +\infty[$.
    \end{minipage}\hfill
    \begin{minipage}{0.48\linewidth}
    ...
    {$x$ / 1, $signe \, f'(x)$ / 1, $var \, f$ / 1}    {$0$, $+\infty$}
    \tkzTabLine{, -, }
    \tkzTabVar{+/$8$ , -/$0$}
    \end{tikzpicture}
\end{center}
   ...
   \thispagestyle{DS_LP}
    \item Déterminer l'équation de la tangente à la courbe représentative de la fonction $f$ au point d'abscisse 0.
        \begin{answer}{1}{4} 
        La tangente à la courbe représentative de la fonction $f$ au point d'abscisse 0 a pour équation $$y = f'(0)(x-0) + f(0)$$
        Or, $f(0) = (2\times 0 + 8)\e^{-0.5\times 0} = 8$ et $f'(0) = -(0+2)\e^{-0.5\times 0} = -2$. \\
        Ainsi, l'équation de la tangente est $y = -2x + 8$.
        \end{answer}
    ...
    \begin{answer}{1}{1}  Avec Géogebra on trouve que la fonction devient inférieure à 2 Mbps à partir d'une distance de 421 mètres   \end{answer}
...
\begin{enumerate}
    \item Vérifier que $G$ est une primitive de la fonction $p$.
        ...
        $G'(t) = (-6 - 0.5(-6t - 12))\e^{-0.5t} = (-6 + 3t + 6)\e^{-0.5t} = 3t\e^{-0.5t} = p(t)$

        Donc, $G$ est bien une primitive de $p$.
        
         \end{answer}
\item La transmission commence sans données transférées. Déterminer alors la primitive $H$ de la fonction $p$ vérifiant $H(0)=0$.
    \begin{answer}{1}{3}  
      $H(t)=G(t)+C$ où $C$ est une constante à déterminer. \\
      Or, $H(0)=G(0)+C=(-6\times 0 - 12)\e^{-0.5\times 0} + C = -12 + C$. \\
      Puisque $H(0)=0$, on en déduit que $C=12$. \\
      Ainsi, $H(t) = (-6t - 12)\e^{-0.5t} + 12$.
    ...
    \item Déterminer le volume total de données transféré au bout de 10 minutes, arrondir à l'unité près.
        ...
        $H(10) = (-6\times 10 - 12)\e^{-0.5\times 10} + 12 \approx 11$ Mo.

        Donc, le volume total de données transféré au bout de 10 minutes est d'environ 11 Mo.
