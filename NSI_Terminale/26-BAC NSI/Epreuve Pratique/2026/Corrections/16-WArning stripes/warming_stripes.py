...
def ecart_temperature(datas, annee):
    for mesure in datas:
        if mesure["année"] == annee:
            return mesure["écart"]
    return None


assert ecart_temperature([{"année": 2026, "écart": 1.5}], 2026) == 1.5
assert ecart_temperature([{"année": 2026, "écart": 1.5}], 2027) == None
