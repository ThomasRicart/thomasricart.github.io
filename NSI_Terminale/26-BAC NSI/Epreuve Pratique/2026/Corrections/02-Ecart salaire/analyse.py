...
assert ecart_salaire([ {'experience': 5, 'etudes': 3, 'sexe': 'F', 'salaire': 2400}]) == None
e = donnees.employes
assert ecart_salaire(e) <= 100
assert ecart_salaire(e) >= 0
...
print(salaire_par_proximite(donnees.employes, e1))
print(salaire_par_proximite(donnees.employes, e2))