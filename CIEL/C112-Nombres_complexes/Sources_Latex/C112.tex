...
\begin{exercice_cours}[Calcul de $\i^n$]
	\begin{itemize}
		\item Calculer les valeurs de $\i^2$, $\i^3$, $\i^4$, $\i^5$\ldots
			...
			\item faire varier $\i$ et observer ce qu'il se passe dans la partie graphique
	\end{itemize}
\end{exercice_cours}
...
\begin{methode}[Méthode de la quantité conjuguée]
	...
	Pour calculer un quotient $\dfrac{z_1}{z_2}$, on multiplie le haut et le bas par $\conj{z_2}$.
	\end{methode}
