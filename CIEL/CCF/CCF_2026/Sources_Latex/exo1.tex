...
\begin{enumerate}[series=monDS, resume]
    ...
    \end{blocvisiblex}
    \medskip
    \item Calculer l'énergie dissipée pendant les 5 premières millisecondes. Donner une valeur exacte puis une valeur approchée à $10^{-2}$ près. 
    \begin{blocvisiblex}[height=2]
    {\quad}
    \end{blocvisiblex}
    \medskip
    \item Déterminer alors l'énergie moyenne dissipée par milliseconde pendant les 5 premières millisecondes.
    \begin{blocvisiblex}[height=2]
    {\quad}
    \end{blocvisiblex}
    \medskip
