...
\begin{enumerate}[resume=monDS]
    ...
    \begin{blocvisiblex}[height=1.5]
    {\quad}
    $P(D)=P(A\cap D)+P(B\cap D)=P(A) \times P_D(A)+P(B) \times P_D(B)=0,75 \times 0,02+0,25 \times 0,06=0,029$

        \smallskip
    La probabilité que la passerelle soit défectueuse est de $0,029$.
    \end{blocvisiblex}
    \medskip
    ...
    {\quad}
    $P_A(D)=\dfrac{P(A\cap D)}{P(D)}=\dfrac{P(A) \times P_D(A)}{P(D)}=\dfrac{0,75 \times 0,02}{0,029}\approx 0,5172$

        \smallskip
    La probabilité que la passerelle soit de type \textbf{Alpha} sachant qu'elle est défectueuse est $0,5172$.
     \end{blocvisiblex}
     \medskip
    ...
    {\quad}
    \begin{itemize}
        \item "choisir une passerelle défectueuse" est une expérience à deux issues: "la passerelle est défectueuse" de $p=0,029$ et "la passerelle n'est pas défectueuse" de $p=0,971$
        ...
        \item Donc $Y$ suit une loi binomiale de paramètres $n=30$ et $p=0,029$.
    \end{itemize}
    \end{blocvisiblex}
        \medskip
    ...
    \begin{blocvisiblex}[height=1.5]
    {\quad}
    $P(Y\geq 2)\approx 0,2158$

        \smallskip
    La probabilité d'avoir au moins 2 passerelles défectueuses dans ce lot est d'environ $0,2158$.
    \end{blocvisiblex}
    \medskip
    ...
    $P(Y=3)\approx 0,0447$
        ...
        \smallskip  
    La probabilité d'avoir exactement 3 passerelles défectueuses dans ce lot est d'environ $0,0447$.
    \end{blocvisiblex}
    \medskip
    ...
    \begin{blocvisiblex}[height=2]
    {\quad}
    $P(Y\geq 1)=1-P(Y=0)=1-\binom{n}{0} \times 0,029^0 \times (1-0,029)^n = 1-(1-0,029)^n=1-0,971^n$  
             ...
             \item Déterminer une primitive $F$ de la foncton $f$.
                ...
                $F(x)=\dfrac{5}{2}x^2-10(x\ln(x)-x)$
                 ...
                 \item Calculer le gain moyen du circuit sur la plage de fréquence $[1;3]$ arrondi à $10^{-2}$ près.
                    \begin{blocvisiblex}[height=1.5]
                    {\quad}
                    Le gain moyen du circuit sur la plage de fréquence $[1;3]$ est de $\dfrac{1}{3-1}\int_1^3 f(x) \, \dx\approx 7,04$ dB.
                     \end{blocvisiblex}
...
\begin{enumerate}[series=monDS, resume]
    ...
    \end{blocvisiblex}
    \medskip
    \item Déterminer à l'aide de Géogébra à partir de quelle heure le modèle Gamma devient plus avantageux que le modèle de la partie C.
    \begin{blocvisiblex}[height=1.]
    {\quad}
    Le modèle Gamma devient plus avantageux que le modèle de la partie C à partir de la 10ème heure.
    \end{blocvisiblex}
    \end{enumerate}
